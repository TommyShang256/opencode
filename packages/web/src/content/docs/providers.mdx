...
For ChatGPT OAuth, OpenCode automatically applies EU or US compute residency requirements advertised by your workspace credentials. No additional configuration is required.
